...
\subsubsection*{Trasmissione di dati in tempo reale}
...
\subsubsection*{Documentazione online}
...
\subsubsection*{Sviluppo e migrazione backend}
...
\subsubsection*{Sviluppo e migrazione frontend}
...
\subsubsection*{Analisi dal punto di vista dello sviluppatore frontend}
...
\end{itemize}
\subsubsection*{Analisi dal punto di vista dello sviluppatore backend}
...
\newpage
\subsection{Tabella di comparazione riassuntiva}
\FloatBarrier
\begin{table}[h!]
